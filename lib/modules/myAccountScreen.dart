...
import 'package:os_project/modules/profileScreen.dart';
              ...
              [
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Welcome! ${cubit.userModel!.data!.name!.split(' ').elementAt(0).toUpperCase()}',
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children:
                      [
                        Icon(Icons.dark_mode_outlined,color: Colors.red,),
                        separator(15, 0),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children:
                      [
                        Icon(Icons.phone_in_talk_outlined,color: Colors.red,),
                        separator(15, 0),
